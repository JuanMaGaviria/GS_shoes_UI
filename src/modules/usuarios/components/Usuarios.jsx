...
export default function Usuarios() {
    ...
    const handleCloseModal = () => {
        ...
        setModalData(null);
        setFormData({
            nombre_completo: '', identificacion: '', telefono: '', correo: '', password: ''
        });
    };
    // Función de creación
        ...
        <div>
            ...
            <div className="">
                ...
                <div className="bg-white cont_principal">
                    <h1 className="gloria ml-1 justify-between items-center font-semibold text-2xl" style={{ color: '#1a1a1a' }}><span style={{ color: '#F09ECB' }}>G</span>estión de <span style={{ color: '#F09ECB' }}>U</span>suarios</h1>
